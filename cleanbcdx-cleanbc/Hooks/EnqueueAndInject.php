...
class EnqueueAndInject {
	...
	public function bcgov_plugin_enqueue_scripts(): void {
		$plugin_dir = \Bcgov\Plugin\CleanBCDXCBC\Setup::get_plugin_dir();
		$assets_dir = $plugin_dir . 'dist/assets/';

		$plugin_version = \Bcgov\Plugin\CleanBCDXCBC\Setup::get_plugin_version();
		$plugin_base    = \Bcgov\Plugin\CleanBCDXCBC\Setup::get_plugin_basename();
