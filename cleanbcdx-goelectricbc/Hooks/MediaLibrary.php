...
class MediaLibrary {
	...
	protected function normalize_unity_vehicle_csv_record( $record, $line_number, $error_code_prefix, $feed_label, $csv_options = array() ) {
		$entry = array(
			...
			'model_name'          => $this->get_unity_vehicle_required_csv_text( $record, 'model_name', $line_number, $error_code_prefix, $feed_label ),
			'configuration_name'  => $this->get_unity_vehicle_required_csv_text( $record, 'configuration_name', $line_number, $error_code_prefix, $feed_label ),
			'year'                => $this->get_unity_vehicle_required_csv_integer( $record, 'year', $line_number, $error_code_prefix, $feed_label ),
			'vehicle_class_name'  => $this->get_unity_vehicle_required_csv_text( $record, 'vehicle_class_name', $line_number, $error_code_prefix, $feed_label ),
			'vehicle_type_name'   => $this->get_unity_vehicle_required_csv_text( $record, 'vehicle_type_name', $line_number, $error_code_prefix, $feed_label ),
			'fuel_type_name'      => $this->get_unity_vehicle_required_csv_text( $record, 'fuel_type_name', $line_number, $error_code_prefix, $feed_label ),
