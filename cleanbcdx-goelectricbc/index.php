 ...
 * Plugin URI: https://github.com/bcgov/wordpress-cleanbcdx/tree/main/cleanbcdx-goelectricbc
 * Update URI: https://raw.githubusercontent.com/bcgov/wordpress-cleanbcdx/main/cleanbcdx-goelectricbc/index.php
...
if ( class_exists( 'Bcgov\\Plugin\\CleanBCDXGE\\Loader' ) ) {
    $base_dir = plugin_dir_path( __FILE__ ) . '/';
    $loader   = new Bcgov\Plugin\CleanBCDXGE\Loader( [ $base_dir ] ); // Pass the base directory as an array.
    $loader->register();
...
if ( class_exists( 'Bcgov\\Plugin\\CleanBCDXGE\\Setup' ) ) {
    new Bcgov\Plugin\CleanBCDXGE\Setup();
}
